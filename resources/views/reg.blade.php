...
<head>
    ...
    <title>Регистрация | DobroNews</title>
        ...
        <div class="col-md-6 col-lg-5">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-0 pt-4 pb-0">
                    ...
                    <p class="text-muted text-center small mt-2">Создайте новый аккаунт</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-link text-primary text-decoration-none fw-bold mt-2">
                            Войти в аккаунт <i class="fas fa-arrow-right ms-1"></i>
                        </a>
                    </div>
                </div>
            </div>
